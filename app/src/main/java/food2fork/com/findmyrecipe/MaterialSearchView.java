...
import food2fork.com.findmyrecipe.utils.AnimationUtility;
...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private void initiateView() {
        ...
        setAnimationDuration(AnimationUtility.ANIMATION_DURATION_MEDIUM);
    }
...
//        mSearchSrcTextView.setText(null);
    ...
    private void setVisibleWithAnimation() {
        AnimationUtility.AnimationListener animationListener = new AnimationUtility.AnimationListener() {
            @Override
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            AnimationUtility.reveal(mSearchTopBar, animationListener);

        } else {
            AnimationUtility.fadeInView(mSearchLayout, mAnimationDuration, animationListener);
        }
    }
